...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(9)().done(function () {
	    setTimeout(function () {
	        ...
	        $({}).will(function () {
	            return $(".index-title-wrap").animateCss("bounceIn");
	        }).delay(1000).will(function () {
	            return $(".index-title-wrap").animateCss("bounceIn");
	        });
	    }, 300);
	});
	...
	function showResult(score) {
	    ...
	    var content = ['<h2>骨灰级剁手党</h2><p>总在深夜想起<br/>诗和远方<br/>还有钱包空荡荡</p>', '<h2>重度剁手党患者</h2><p>买买买时指点江山<br/>激扬文字<br/>却总在深夜听钱哭的声音</p>', '<h2>中度剁手党患者</h2><p>买买买时残留<br/>一丝“人性”<br/>尚能顾虑到钱包的感受</p>', '<h2>专业伪剁手党</h2><p>梦想成为一枚叱咤江湖<br/>的剁手党老大<br/>奈何金钱总是投奔他方</p>'][level - 1];
	...
	var Game = function () {
	    ...
	    _createClass(Game, [{
	        ...
	        value: function bindEvents() {
	            ...
	            wrap.on("touchstart", ".duo", function () {
	                // 点击到无效区域
	                var self = $(this);
	            ...
	            wrap.on("touchstart", ".duo-p", function () {
	                // 点击到有效区域
...
/***/ function(module, exports, __webpack_require__) {
	...
	function makeAnimate(callback) {
	    ...
	    ele.will(function (n) {
	        $(".game-shadow").show();
	        eleNum.removeClass("num-1 num-2 num-3").addClass("num-3").animateCss("bounceIn");
	    }).delay(1000).will(function (n) {
	        eleNum.removeClass("num-1 num-2 num-3").addClass("num-2").animateCss("bounceIn");
	    }).delay(1000).will(function (n) {
	        eleNum.removeClass("num-1 num-2 num-3").addClass("num-1").animateCss("bounceIn");
	    }).delay(1000).will(function () {
	        eleNum.hide();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = __webpack_require__(4);
	var imgArr = ['btn-line-bg.png', 'btn-line-bg02.png', 'btn-narrow.png', 'btn-onemore.png', 'btn-tigao.png', 'duo_knife.png', 'duo_styleA.png', 'duo_styleB.png', 'duo_styleC.png', 'duoshou_bg_06.png', 'duoshou_bg_dot.png',
	// 'img_guide_weixin.png',
	'index-bg.png', 'index-title.png', 'index_star_btn.png', 'loading_bg.png', 'logo.png', 'music.png', 'music_sel.png', 'num_bg.png', 'playPool_bg.png', 'playPool_txt.png', 'result-2code.png'];
	...
	var cbs = imgArr.map(function (n) {
	    return preloadImg('dist/img/' + n);
	});
